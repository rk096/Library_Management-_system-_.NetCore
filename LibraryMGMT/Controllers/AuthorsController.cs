...
namespace LibraryMGMT.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        {
            var authors = _context.Authors.ToList(); // Replace with your actual data retrieval method
            ViewBag.AuthorId = new SelectList(authors, "AuthorId", "Name"); // Assuming "ID" and "Name" are the properties in your Author model
           // return View();
            return View();
        }
